...
public abstract class Tile
{
    ...
    public float Width { get; private set; }       // Width of the UI Element
    public float Height { get; private set; }      // Height of the UI Element
    public Position Position { get; set; }  // Position on the canvas
    public static float Size { get; private set; } =
#if WINDOWS
        (App.WindowWidth - 50) / 2f;
#else
        (float)DeviceDisplay.Current.MainDisplayInfo.Width / 6f;
#endif
